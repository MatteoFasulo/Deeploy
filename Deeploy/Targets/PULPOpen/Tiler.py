...
from Deeploy.Targets.Generic.TileConstraints.QuantTileConstraint import QuantTileConstraint
...
from Deeploy.Targets.PULPOpen.Bindings import PULPAddBindings, PULPConcatBindings, PULPDequantBindings, \
    ...
    PULPMulBindings, PULPQuantBindings, PULPQuantizedConv2DBindings, PULPQuantizedGEMMBindings, \
...
from Deeploy.Targets.PULPOpen.TileConstraints.ReduceMeanConstraint import ReduceMeanConstraint
...
PULPReduceMeanTilingReadyBindings = TilingReadyNodeBindings(nodeBindings = PULPReduceMeanBindings,
                                                            tileConstraint = ReduceMeanConstraint())
